...
module.exports = {
    init: function(a, t, c, i, r, s) {
        ...
        o.isShowSearchKey = void 0 === i || i, o.isShowSearchHistory = void 0 === r || r, 
        n.keys = c, wx.getSystemInfo({
            success: function(e) {
                var c = e.windowHeight;
                o.seachHeight = c - t, n.view = o, a.setData({
                    wxSearchData: n
                });
            }
    ...
    wxSearchInput: function(a, e, t) {
        ...
        if (void 0 === r || 0 == r.length) ; else for (var n = 0; n < c.length; n++) {
            var o = c[n];
            o.indexOf(r) > -1 && s.push(o);
        }
        i.value = r, i.mindKeys = s, e.setData({
            wxSearchData: i
        });
    },
    updateHotMindKeys: function(a, e) {
        var t = a.data.wxSearchData, i = !1, r = !1;
        for (var s in t.keys) if (t.keys[s] == e) {
            i = !0;
            break;
        }
        0 == i && (t.keys.pop(), t.keys.unshift(e));
        for (var s in c) if (c[s] == e) {
            r = !0;
            break;
        }
        0 == r && (c.pop(), c.unshift(e)), a.setData({
            wxSearchData: t
        });
    },
